...
class AK4Jet {
 ...
 public:
  ...
  float jesup_total;
  float jesdn_total;
  float btag_DeepFlav_med_SF;
  float btag_DeepFlav_med_SF_up;
  float btag_DeepFlav_med_SF_dn;
  float btag_DeepFlav_loose_SF;
  float btag_DeepFlav_loose_SF_up;
  float btag_DeepFlav_loose_SF_dn;
/*    float  reso;
    float  reso_up;
    float  reso_dn;
    float jesup_pu;
